...
import styles from './AdminsPost.module.css'
            ...
            <div className={styles.fieldRow}>
              <div className={styles.field}>
                ...
                <div className={styles.inputWithIcon}>
                  ...
                  <input name="shopName" type="text" placeholder="Enter shop name" value={form.shopName} onChange={handleChange} className={errors.shopName ? styles.fieldError : ''} />
                </div>
                ...
                <div className={styles.imagePreviewPanel}>
                  ...
                  {imagePreview ? (
                    ...
                    <div className={styles.previewPlaceholder}>
                      <span>Shop image will appear here</span>
                    </div>
                  )}
                </div>
              </div>
